...
# 任务输出维度映射
task_dim_map = {
    "20-c": 20, "4-c": 4, "fast/slow": 2, 
    "color": 5, "number": 2, "face": 2, "human": 2 # 假设 human 也是 2
}
...
if __name__ == "__main__":
    print("using feature: ", train_config["feature"])
    print("using model: ", train_config["model_name"])
    print("using task: ", train_config["task"])
    print("using data: ", train_config["data"])
    main()